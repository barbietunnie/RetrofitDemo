package com.b8labs.retrofitdemo;
...
import com.b8labs.retrofitdemo.core.BusProvider;
import com.b8labs.retrofitdemo.core.Communicator;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onServerEvent(ServerEvent serverEvent) {
        ...
        if(serverEvent.getServerResponse().getUsername() != null) {
            information.setText("Username: " + serverEvent.getServerResponse().getUsername()
                                    + " || Password: " + serverEvent.getServerResponse().getPassword());
        }
